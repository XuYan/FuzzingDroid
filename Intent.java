...
import android.fuzzingDroid.FuzzingDroid;
...
public class Intent implements Parcelable, Cloneable {
    ...
    // @author: Xu Yan
    public static final boolean FUNC_ENABLED = true;
   ...
   /**
    ...
    public boolean getBooleanExtra(String name, boolean defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-boolean", name + "-boolean");
            return mExtras == null ? FuzzingDroid.getBooleanValue() : mExtras.getBoolean(name, defaultValue);
        }
    ...
    public byte getByteExtra(String name, byte defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-byte", name + "-byte");
            return mExtras == null ?  FuzzingDroid.getByteValue() : mExtras.getByte(name, defaultValue);
        }
    ...
    public short getShortExtra(String name, short defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-short", name + "-short");
            return mExtras == null ?  FuzzingDroid.getShortValue() : mExtras.getShort(name, defaultValue);
        }
    ...
    public char getCharExtra(String name, char defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-char", name + "-char");
            return mExtras == null ?  FuzzingDroid.getCharValue() : mExtras.getChar(name, defaultValue);
        }
    ...
    public int getIntExtra(String name, int defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-int", name + "-int");
            return mExtras == null ?  FuzzingDroid.getIntValue() : mExtras.getInt(name, defaultValue);
        }
    ...
    public long getLongExtra(String name, long defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-long", name + "-long");
            return mExtras == null ?  FuzzingDroid.getLongValue() : mExtras.getLong(name, defaultValue);
        }
    ...
    public float getFloatExtra(String name, float defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-float", name + "-float");
            return mExtras == null ?  FuzzingDroid.getFloatValue() : mExtras.getFloat(name, defaultValue);
        }
    ...
    public double getDoubleExtra(String name, double defaultValue) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-double", name + "-double");
            return mExtras == null ?  FuzzingDroid.getDoubleValue() : mExtras.getDouble(name, defaultValue);
        }
    ...
    public String getStringExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-String", name + "-String");
            return mExtras == null ?  FuzzingDroid.getStringValue() : mExtras.getString(name);
        }
    ...
    public CharSequence getCharSequenceExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-CharSequence", name + "-CharSequence");
            return mExtras == null ?  FuzzingDroid.getCharSequenceValue() : mExtras.getCharSequence(name);
        }
    ...
    public <T extends Parcelable> T getParcelableExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-Parcelable", name + "-Parcelable");
        }
    ...
    public Parcelable[] getParcelableArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-Parcelable[]", name + "-Parcelable[]");
            return mExtras == null ? FuzzingDroid.getParcelableArrayValue() : mExtras.getParcelableArray(name);
        }
    ...
    public <T extends Parcelable> ArrayList<T> getParcelableArrayListExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-ArrayList<Parcelable>", name + "-ArrayList<Parcelable>");
            return mExtras == null ? (ArrayList<T>) FuzzingDroid.getParcelableArrayListValue() : mExtras.<T>getParcelableArrayList(name);
        }
    ...
    public Serializable getSerializableExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-Serializable", name + "-Serializable");
        }
    ...
    public ArrayList<Integer> getIntegerArrayListExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-ArrayList<Integer>", name + "-ArrayList<Integer>");
            return mExtras == null ?  FuzzingDroid.getIntegerArrayListValue() : mExtras.getIntegerArrayList(name);
        }
    ...
    public ArrayList<String> getStringArrayListExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-ArrayList<String>", name + "-ArrayList<String>");
            return mExtras == null ?  FuzzingDroid.getStringArrayListValue() : mExtras.getStringArrayList(name);
        }
    ...
    public ArrayList<CharSequence> getCharSequenceArrayListExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-ArrayList<CharSequence>", name + "-ArrayList<CharSequence>");
            return mExtras == null ?  FuzzingDroid.getCharSequenceArrayListValue() : mExtras.getCharSequenceArrayList(name);
        }
    ...
    public boolean[] getBooleanArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-boolean[]", name + "-boolean[]");
            return mExtras == null ?  FuzzingDroid.getBooleanArrayValue() : mExtras.getBooleanArray(name);
        }
    ...
    public byte[] getByteArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-byte[]", name + "-byte[]");
            return mExtras == null ?  FuzzingDroid.getByteArrayValue() : mExtras.getByteArray(name);
        }
    ...
    public short[] getShortArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-short[]", name + "-short[]");
            return mExtras == null ?  FuzzingDroid.getShortArrayValue() : mExtras.getShortArray(name);
        }
    ...
    public char[] getCharArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-char[]", name + "-char[]");
            return mExtras == null ?  FuzzingDroid.getCharArrayValue() : mExtras.getCharArray(name);
        }
    ...
    public int[] getIntArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-int[]", name + "-int[]");
            return mExtras == null ?  FuzzingDroid.getIntArrayValue() : mExtras.getIntArray(name);
        }
    ...
    public long[] getLongArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-long[]", name + "-long[]");
            return mExtras == null ?  FuzzingDroid.getLongArrayValue() : mExtras.getLongArray(name);
        }
    ...
    public float[] getFloatArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-float[]", name + "-float[]");
            return mExtras == null ?  FuzzingDroid.getFloatArrayValue() : mExtras.getFloatArray(name);
        }
    ...
    public double[] getDoubleArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-double[]", name + "-double[]");
            return mExtras == null ?  FuzzingDroid.getDoubleArrayValue() : mExtras.getDoubleArray(name);
        }
    ...
    public String[] getStringArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-String[]", name + "-String[]");
            return mExtras == null ?  FuzzingDroid.getStringArrayValue() : mExtras.getStringArray(name);
        }
    ...
    public CharSequence[] getCharSequenceArrayExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-CharSequence[]", name + "-CharSequence[]");
            return mExtras == null ?  FuzzingDroid.getCharSequenceArrayValue() : mExtras.getCharSequenceArray(name);
        }
    ...
    public Bundle getBundleExtra(String name) {
        if (FUNC_ENABLED) {
            Slog.d("Intent:key-Bundle", name + "-Bundle");
            return mExtras == null ?  new Bundle() : mExtras.getBundle(name);
        }
    ...
    public Bundle getExtras() {
        if (FUNC_ENABLED) {
            Slog.d("Intent's mExtras", "Intent's mExtras");
            return (mExtras != null) ? new Bundle(mExtras) : new Bundle();
        }
        return (mExtras != null)
                ? new Bundle(mExtras)
                : null;
